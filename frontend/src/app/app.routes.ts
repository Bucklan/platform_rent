...
export const routes: Routes = [
  ...
  {path: 'wash/create', title: "Create Wash", component: WashCreateComponent, canActivate: [AuthGuard]},
  ...
  {path: 'users', title: "Users", component: UserComponent, canActivate: [AuthGuard]},
  {path: 'upload', title: 'upload', component: UploadComponent},
];
